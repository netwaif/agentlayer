...
명령:
  ...
  restore        죽은 세션 배치 부활 — 체크리스트로 골라 실행  [--resume 대화째] [--yes 전부] [--dry-run] [id ...]  (LaunchAgent 봇 제외)
  ...
  browser [open|pick|shot|errors|preview|cookies|mcp]  에이전트 전용 브라우저 (기동/탭 열기/요소찍기/캡처/콘솔에러/wt 프리뷰/쿠키/MCP 연동 명령)
