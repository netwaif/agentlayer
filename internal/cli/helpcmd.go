...
명령:
  ...
  browser [open|pick|shot|errors|preview|cookies|mcp|control reset]  에이전트 전용 브라우저 (기동/탭 열기/요소찍기/캡처/콘솔에러/wt 프리뷰/쿠키 import·list·clear·export/MCP 연동 명령/제어권 초기화)
